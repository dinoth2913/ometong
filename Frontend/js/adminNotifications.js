/* =========================================================
   OMETONG — ADMIN NOTIFICATION BELL
   public.notifications already gets rows written to it by triggers
   all over the schema (new inquiry message, new contact message,
   new refund request, new supplier application, order status
   changes) — this was the missing piece: nothing anywhere ever
   actually read them back. RLS ("Users can view/mark their own
   notifications") already covers this, no new SQL needed.
========================================================= */
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // page reload — cheap, and matches how the rest of the admin
  // panel already just re-fetches on demand rather than using
