...
(function () {
  ...
  var TRANSLATIONS = {
    en: {
      ...
      "nav.suppliers": "For Suppliers", "nav.advertise": "Advertise", "nav.contact": "Contact Us", "nav.login": "Login", "nav.becomeSupplier": "Become a Supplier",
      "hero.tag": "✦ For Suppliers & Manufacturers",
      "hero.h1a": "Sell to the world.", "hero.h1b": "Skip the cold outreach.",
      "hero.p": "List once, respond to buyer requests for quotation directly, get paid through escrow, and let Ometong Market's logistics network handle freight and customs — so you can focus on making and shipping product.",
      ...
      "benefits.b1.h": "Direct buyer requests",
      ...
      "how.s2.h": "List products & services", "how.s2.p": "Add your products with prices, minimum order amounts, and how long they take to make, tagged by category so the right buyers can find it in search.",
      ...
      "pricing.growth.p": "Unlimited listings with priority placement.",
      ...
      "footer.brand": "The marketplace built for global trade — products, services and logistics, all in one place.",
    ...
    zh: {
      ...
      "nav.suppliers": "供应商专区", "nav.advertise": "广告合作", "nav.contact": "联系我们", "nav.login": "登录", "nav.becomeSupplier": "成为供应商",
      "hero.tag": "✦ 面向供应商与制造商",
      "hero.h1a": "把产品卖向全世界。", "hero.h1b": "不用再做陌生开发。",
      "hero.p": "只需上架一次，直接响应买家的采购询价请求，货款通过担保交易安全支付，Ometong 的物流网络负责运输和报关 — 您只需专心生产和发货。",
      ...
      "how.s2.h": "上架产品与服务", "how.s2.p": "填写价格、起订量和生产周期，按类别标记，方便买家在搜索中找到您。",
      ...
      "pricing.growth.p": "无限量上架商品，享优先展示位置。",
      ...
      "apply.f.submit": "提交申请",
      "footer.brand": "为全球贸易打造的平台 — 产品、服务与物流，一站式解决。",
    ...
    es: {
      ...
      "nav.suppliers": "Para Proveedores", "nav.advertise": "Publicidad", "nav.contact": "Contáctenos", "nav.login": "Iniciar sesión", "nav.becomeSupplier": "Ser Proveedor",
    ...
    fr: {
      ...
      "nav.suppliers": "Pour les fournisseurs", "nav.advertise": "Publicité", "nav.contact": "Nous contacter", "nav.login": "Connexion", "nav.becomeSupplier": "Devenir fournisseur",
    ...
    hi: {
      ...
      "nav.suppliers": "सप्लायर के लिए", "nav.advertise": "विज्ञापन दें", "nav.contact": "संपर्क करें", "nav.login": "लॉगिन", "nav.becomeSupplier": "सप्लायर बनें",
      "hero.tag": "✦ सप्लायर और निर्माताओं के लिए",
      "hero.h1a": "पूरी दुनिया को बेचें।", "hero.h1b": "कोल्ड आउटरीच की ज़रूरत नहीं।",
      "hero.p": "एक बार लिस्ट करें, खरीदारों के कोटेशन अनुरोधों का सीधे जवाब दें, एस्क्रो के ज़रिए सुरक्षित भुगतान पाएं, और शिपिंग व कस्टम्स का काम Ometong का लॉजिस्टिक्स नेटवर्क संभालेगा — आप सिर्फ़ बनाने और भेजने पर ध्यान दें।",
      ...
      "benefits.b1.h": "सीधे खरीदार अनुरोध",
      ...
      "how.s2.h": "प्रोडक्ट और सेवाएँ लिस्ट करें", "how.s2.p": "कीमत, न्यूनतम ऑर्डर मात्रा और बनने में लगने वाले समय के साथ अपने प्रोडक्ट जोड़ें, श्रेणी के अनुसार टैग किया गया ताकि सही खरीदार खोज में उसे ढूँढ सकें।",
      ...
      "pricing.growth.p": "प्राथमिकता प्लेसमेंट के साथ असीमित लिस्टिंग।",
      ...
      "footer.brand": "वैश्विक व्यापार के लिए बना मार्केटप्लेस — प्रोडक्ट, सेवाएँ और लॉजिस्टिक्स, सब एक ही जगह।",
    ...
    si: {
      ...
      "nav.suppliers": "සැපයුම්කරුවන් සඳහා", "nav.advertise": "වෙළඳ දැන්වීම්", "nav.contact": "අප අමතන්න", "nav.login": "පිවිසෙන්න", "nav.becomeSupplier": "සැපයුම්කරුවෙකු වන්න",
      "hero.tag": "✦ සැපයුම්කරුවන් සහ නිෂ්පාදකයින් සඳහා",
      "hero.h1a": "ලෝකයටම විකුණන්න.", "hero.h1b": "සීතල ප්‍රචාරණයකින් තොරව.",
      "hero.p": "එක් වරක් ලැයිස්තුගත කර ගැනුම්කරුවන්ගේ මිල ගණන් ඉල්ලීම්වලට සෘජුවම ප්‍රතිචාර දක්වන්න, එස්ක්‍රෝ හරහා ආරක්ෂිතව ගෙවීම් ලබා ගන්න, නැව්ගත කිරීම සහ රේගු කටයුතු Ometong හි ලොජිස්ටික්ස් ජාලය හසුරුවයි — ඔබ නිෂ්පාදනය කිරීම හා යැවීම කෙරෙහි පමණක් අවධානය යොමු කරන්න.",
      ...
      "benefits.b1.h": "සෘජු ගැනුම්කරු ඉල්ලීම්",
      ...
      "how.s2.h": "නිෂ්පාදන සහ සේවා ලැයිස්තුගත කරන්න", "how.s2.p": "මිල, අවම ඇණවුම් ප්‍රමාණය සහ නිෂ්පාදන කාලය සමඟ ඔබේ නිෂ්පාදන එකතු කරන්න, නිවැරදි ගැනුම්කරුවන්ට සෙවීමේදී සොයාගත හැකි වන පරිදි කාණ්ඩය අනුව ටැග් කර ඇත.",
      ...
      "pricing.growth.p": "ප්‍රමුඛතා ස්ථානගත කිරීම සමඟ අසීමිත ලැයිස්තු.",
      ...
      "footer.brand": "ගෝලීය වෙළඳාම සඳහා නිර්මාණය කළ වෙළඳපොළ — නිෂ්පාදන, සේවා සහ ලොජිස්ටික්ස්, සියල්ල එකම තැනක.",
